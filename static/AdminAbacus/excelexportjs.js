    ...
    $.fn.excelexportjs = function (options) {
        ...
        function Export(htmltable) {
            ...
            if (isBrowserIE()) {
                ...
                console.log('B', $settings.worksheetName)
                ...
                console.log('.......>>>>>', uri)
                var ctx = { worksheet: $settings.fileName, table: htmltable };
                console.log('....,', ctx);
        ...
        function format(s, c) {
            return s.replace(/{(\w+)}/g, function (m, p) {
                console.log('00000000000',s,'>>>>>>>>>>>>>>>>>',c,'kkkkkk')
                return c[p]; });
        }
        ...
        function exportToExcelIE(table) {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))      // If Internet Explorer
            {
                ...
                txtArea1.focus();
                sa = txtArea1.document.execCommand("SaveAs", true, $settings.fileName);
            }
            else
