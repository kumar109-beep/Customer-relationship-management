function searchCategory() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            response.trim() === 'True' ? $('.checkCat').html('Category Name Exist') : $('.checkCat').html('Category Name')
...
//                 console.log(arr[j]);
//                 $("#add-cats").append('<div class="row">   <div class="col-lg-11 mt-3 mb-3">   <input type="text" class="form-control" name="Store_sub_category" placeholder="Enter sub category name" value=' +arr[j].trim()+' /> </div><div class="col-lg-1 mt-3 pt-2 "> <a href="#" class="  remove_c"><i class="fa fa-minus-circle"></i></a> </div>  </div>');      
//                 };
