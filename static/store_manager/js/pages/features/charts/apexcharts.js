...
var KTApexChartsDemo = function () {
	...
	var _demo1 = function () {
		...
		var options = {
			series: [{
				name: "Desktops",
				data: [10, 70, 35, 81, 49, 62, 69, 91, 148]
			}],
			chart: {
				height: 350,
				type: 'line',
			...
			xaxis: {
				categories: ['1/09', '2/09', '3/09', '4/09', '5/09', '6/09', '7/09', '8/09', '9/09'],
			},
			yaxis: {
		          title: {
		            text: 'Total No. of customers (in Hundred)'
		          } 
		        },
			colors: [primary]
		};
	...
	var _demo2 = function () {
		...
		var options = {
			series: [{
				name: "Desktops",
				data: [10, 80, 50, 81, 30, 60, 79, 41, 110]
			}],
			chart: {
				height: 350,
				type: 'line',
